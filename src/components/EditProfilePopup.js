...
class EditProfilePopup extends React.Component {
    ...
    componentDidUpdate() {
        if (this.state.profileName !== this.context.name && this.state.profileName === null){
            this.setState({
        ...
        return(
            ...
            > 
                <label className="popup__field">
                    ...
                    placeholder="Имя" required minLength="2" maxLength="40" value={this.state.profileName ? this.state.profileName : ''} onChange={this.handleChange}/>
                ...
                <label className="popup__field">
                    ...
                    placeholder="Работа" required minLength="2" maxLength="200" value={this.state.profileJob ? this.state.profileJob : ''} onChange={this.handleChange}/>
